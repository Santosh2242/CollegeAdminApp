...
public class FacultyFragment extends Fragment {
    ...
    private RecyclerView csDepartment, itDepartment, physicsDepartment, chemistryDepartment;
    private LinearLayout csNoData, itNoData, physicsNoData, chemistryNoData;
